...
<template>
    <Head><title>Создать статью - Энциклопедия</title></Head>
            ...
            <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 mb-6">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300">Импорт из Википедии</h3>
                    </div>
                    ...
                    <p class="mt-1.5 text-xs text-gray-400 dark:text-gray-500">
                        Поддерживается любой язык Википедии. Статьи не на русском будут переведены через AI.
                    </p>
                </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <PrimaryButton :disabled="form.processing">
                                {{ form.processing ? 'Сохранение...' : 'Создать статью' }}
                            </PrimaryButton>
                        </div>
                    </form>
                </div>
